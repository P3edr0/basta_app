...
// Procura um drawable chamado "ic_notification" dentro do aplicativo
int notificationIcon = getResources().getIdentifier(
        "ic_notification",
        "drawable",
        getPackageName()
);

// Caso não exista, utiliza o ícone padrão do plugin
if (notificationIcon == 0) {
    notificationIcon = R.drawable.ic_bg_service_small;
}
Log.d("Basta", "notificationIcon = " + notificationIcon);
